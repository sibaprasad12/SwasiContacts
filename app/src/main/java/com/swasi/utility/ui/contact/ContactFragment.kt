...
import com.swasi.utility.ui.imagepicker.MyLifecycleObserver
import com.swasi.utility.ui.video.VideoViewModel
...
class ContactFragment : Fragment(), ContactClicklistener {
    ...
    private val adapter: com.swasi.utility.ui.adapters.ContactAdapter by lazy {
        com.swasi.utility.ui.adapters.ContactAdapter(this)
    }
